...
refactored = {"AZN": 35.68, "BYR": 23.91, "EUR": 59.90, "GEL": 21.74, "KGS": 0.76, "KZT": 0.13, "RUR": 1,
...
class Vacancy:
    def __init__(self, row: dict):
        ...
        self.avarage_salary = int((self.salary_from + self.salary_to) / 2 * refactored[self.salary_currency])
